...
{
    // Full object paths (e.g. /Game/KiteDemo/.../Skybox.Skybox) load directly so
    // blueprints living outside /Game/Blueprints (migrated asset packs) are
    // spawnable without copying them into the project blueprint folder.
