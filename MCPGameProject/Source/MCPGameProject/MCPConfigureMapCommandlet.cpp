...
int32 UMCPConfigureMapCommandlet::Main(const FString& Params)
{
	...
	// The caller passes MainMap as source because it is the stable, exact pre-change
	// copy of NewMap; no raw .umap copy is used.
	...
	{
		UE_LOG(LogTemp, Error, TEXT("Usage: -Map=/Game/Maps/NewMap -GameModeClass=/Game/Blueprints/BP_GameMode_Conquest.BP_GameMode_Conquest_C"));
		return 1;
	}
